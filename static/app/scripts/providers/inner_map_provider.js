  ...
  module.provider('InnerMapProvider', function(){
    ...
    this.$get = function(MeasuresProvider){
      return {
        ...
        outerMap: function(bounds, format, orientation){
          var north = bounds.getNorth();
          var south = bounds.getSouth();
          var west = bounds.getWest();
          var east = bounds.getEast();
          ...
          var outer_heigth = (north - south) / format_measures.inner_box_ratios.height;
          var outer_width = (east - west) / format_measures.inner_box_ratios.width;
          ...
          var end_point = new L.LatLng(
            start_point.lat - outer_heigth,
            start_point.lng + outer_width
          );
